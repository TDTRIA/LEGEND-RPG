(() => {
  ...
  function renderSella(){
    const p = loadPlayer();
    if(!p){ location.href = 'index.html?v=0.6.3'; return; }
    ...
    root().innerHTML = `
      <div class="shell">
        <header class="topbar">
          <div class="brand"><h1>LEGEND</h1><div class="sub">Recovered Build v0.6.3</div></div>
        ...
        <div class="layout">
          <section class="panel">
            <div class="panel-head"><div><h2>Sella Marr</h2><p>Inn cook / road provisioner</p></div><span class="value">v0.6.3</span></div>
    ...
    document.getElementById('backLegend').onclick = () => location.href = 'index.html?v=0.6.3';
  }
