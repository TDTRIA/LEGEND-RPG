window.LEGEND_DATA = {
  ...
  regions: {
    ...
    Greyfen:{id:'Greyfen',name:'Greyfen',type:'region',unlockTokens:5,travelCost:25,description:'A drowned lowland of reeds, old shrines, and rare road herbs.'},
    Ironpass:{id:'Ironpass',name:'Ironpass',type:'region',unlockTokens:10,travelCost:45,description:'A hard mountain crossing rich in ore and guarded by tougher creatures.'},
    Blackwood:{id:'Blackwood',name:'Blackwood',type:'region',unlockTokens:15,travelCost:70,description:'A deep forest where hunting, corruption, and old paths intertwine.'},
    RuinedMarch:{id:'RuinedMarch',name:'The Ruined March',type:'region',unlockTokens:25,travelCost:100,description:'A broken frontier where the oldest road secrets begin to surface.'}
  },
  weapons: [
